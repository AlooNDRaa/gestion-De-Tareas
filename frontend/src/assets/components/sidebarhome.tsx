...
function SideBar({theme}) {
    ...
    return (
        <>
        <div className={`bg-gradient-to-b ${theme ? 'from-darkmode-azul1' : 'from-lightmode-blanco'} ${theme ? 'to-darkmode-verdeagua1' : 'to-lightmode-azul'} h-screen p-5 pt-8 ${open ? "w-72" : "w-20"} desktop:relative hidden`}>
